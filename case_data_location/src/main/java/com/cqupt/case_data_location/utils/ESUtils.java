...
import com.cqupt.case_data_location.pojo.model.ESResult;
...
public class ESUtils {
    ...
    public SearchHits getDocByMustColumn(String index, String column, String value) {
        SearchRequest searchRequest = new SearchRequest();
        searchRequest.indices(index);

        SearchSourceBuilder sourceBuilder = new SearchSourceBuilder();

        //创建boolQuery的QueryBuilder
        BoolQueryBuilder boolQuery = QueryBuilders.boolQuery();
        boolQuery.must(QueryBuilders.matchQuery(column,value));
