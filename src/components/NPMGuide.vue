<template>
  <v-col class="npm-guide pa-2 pl-6">
    ...
    <div style="margin-top: 20px">
      <h2>
        Need more information? <br />Find a bug? <br />Need some feature?
        <br />Want to discuss sth with developer?
      </h2>
      <p>
        Welcome to view our
        <a href="https://github.com/synyi/poplar">GitHub</a>.
      </p>
      <p>
        And feel free to
        <a href="https://github.com/synyi/poplar/issues/new">open an issue</a>
