    ...
    <ol>
      ...
      <li>
        ...
        <div>
          ...
          <p>{{ $t("rightPage") }}</p>
          <br />
          <img src="https://i.loli.net/2019/08/30/YUuJnyr8iIAmTft.png" />
        </div>
      </li>
      <li>
        <h2>{{ $t("annotate") }}</h2>
        <div>
          ...
          <img
            alt="1.gif"
            src="https://i.loli.net/2018/08/16/5b751591a98af.gif"
            title="1.gif"
          />
        </div>
      </li>
      <li>
        ...
        <div>
          ...
          <img
            alt="2.gif"
            src="https://i.loli.net/2018/08/16/5b751591c8cc6.gif"
            title="2.gif"
          />
        </div>
      </li>
